...
def test_upsert_updates_existing_snapshot_without_touching_invoice_days_late():
    ...
    upsert_gmail_calendar_signals(client, "acc-1", "2026-08-03", "2026-08-09", 4.5, 3, 1)
...
def test_upsert_inserts_new_snapshot_when_period_not_seeded():
    ...
    upsert_gmail_calendar_signals(client, "acc-1", "2026-09-07", "2026-09-13", 2.0, 1, 0)
    ...
    assert rows[0]["meetings_scheduled"] == 1
